...
<div
  ...
  <div
    ...
    <div class="title-bar-text"><img class="logo" src={faviconUrl} alt={title} width="25" height="25" />{title}</div>
    <div class="title-bar-controls">
      <button aria-label="Minimize" />
      <button aria-label="Maximize" on:click={handleMaximize} />
      <button aria-label="Close" on:click={handleCloseWindow} />
    </div>
  </div>
